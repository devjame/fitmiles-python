...
const usersChart = new Chart(usersCanvas, {
  ...
  data: {
    ...
    datasets: [
      {
        data: [
          21, 20, 24, 20, 18, 17, 15, 17, 18, 30, 31, 30, 30, 35, 25, 35, 35,
          40, 60, 90, 90, 90, 85, 70, 75, 70, 30, 30, 30, 50, 72,
        ],
...
const vistsChart = new Chart(vistsCanvas, {
  ...
  data: {
    ...
    datasets: [
      {
        data: [
          25, 18, 30, 31, 35, 35, 60, 60, 60, 75, 21, 20, 24, 20, 18, 17, 15,
          17, 30, 120, 120, 120, 100, 90, 75, 90, 90, 90, 75, 70, 60,
        ],
        backgroundColor: ["rgba(55, 125, 255, 0)", "rgba(255, 255, 255, 0)"],
        borderColor: "#377dff",
        borderWidth: 2,
...
const articlesCanvas = document
  .getElementById("articlesChart")
  .getContext("2d");
const articlesChart = new Chart(articlesCanvas, {
  ...
  data: {
    ...
    datasets: [
      {
        data: [
          21, 20, 24, 15, 17, 30, 30, 35, 35, 35, 40, 60, 12, 90, 90, 85, 70,
          75, 43, 75, 90, 22, 120, 120, 90, 85, 100, 92, 92, 92, 92,
        ],
        backgroundColor: ["rgba(55, 125, 255, 0)", "rgba(255, 255, 255, 0)"],
        borderColor: "#377dff",
        borderWidth: 2,
...
const updatingMonthlyCanvas = document
  .getElementById("updatingMonthlyChart")
  .getContext("2d");
